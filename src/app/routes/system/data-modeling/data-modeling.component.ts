              ...
              viewCfg: [
                {
                  config: {
                    ...
                    'columns': [
                      ...
                      {
                        title: '表类别', field: 'tableType', width: 80, hidden: false,
                      ...
                      {
                        title: '注释', field: 'comments', width: 80, hidden: false,
                        editor: {
                          type: 'input',
                          field: 'comments',
                          options: {
                      ...
                      {
                        title: '是否发布', field: 'belongPlatformType', width: 80, hidden: false,
                        formatter: [
                          { 'value': '启用', 'bgcolor': '', 'fontcolor': 'text-green', 'valueas': '启用' },
                          { 'value': '禁用', 'bgcolor': '', 'fontcolor': 'text-red', 'valueas': '禁用' }
                        ],
              ...
              viewCfg: [
                {
                  config: {
                    ...
                    'columns': [
                      ...
                      {
                        title: '是否唯一', field: 'isUnique', width: 80, hidden: false,
                        showFilter: true, showSort: true,
                        editor: {
                          type: 'select',
                          field: 'isUnique',
                      ...
                      {
                        title: '是否为空', field: 'isNullabled', width: 80, hidden: false,
                        showFilter: true, showSort: true,
                        editor: {
                          type: 'select',
                          field: 'isNullabled',
                      ...
                      {
                        title: '是否数据字典', field: 'isDataDictionary', width: 80, hidden: false,
                        showFilter: true, showSort: true,
                        editor: {
                          type: 'select',
                      ...
                      {
                        title: '排序', field: 'orderCode', width: 80, hidden: false,
                        editor: {
                          type: 'input',
                          field: 'orderCode',
                          options: {
